...
const Article = ()=>{
    ...
    const article = makeElm('article','col1 ');
        ...
        container.append(ServiceCard("COMBINATION BROWS","£150 inc top up","The best of both worlds. Strokes and shading are carefully placed together for a super natural but full look.<br> Results can be expected to last 18/24 months.",'url("Images/cardImageCombo.jpg")'));
